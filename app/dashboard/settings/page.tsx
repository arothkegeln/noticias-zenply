...
export default function SettingsPage() {
    const { config, addSource, removeSource, addActor, removeActor } = useConfig();

    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                <h2 className="text-3xl font-bold mb-2">Configuración</h2>
                <p className="text-zinc-400">Gestiona tus fuentes de noticias y los actores que deseas seguir.</p>
            </div>
